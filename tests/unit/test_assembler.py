...
class AssemblerTestCase(unittest.TestCase):
    ...
    def test_convert_SYS_node_to_opcode(self):
        ...
        # Act:
        opcodes = assembler.compile(ast)

        # Arrange:
        self.assertEqual('0FFF', opcodes[0])
    ...
    def test_convert_CLS_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('00E0', opcodes[0])
    ...
    def test_convert_RET_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('00EE', opcodes[0])
    ...
    def test_convert_JMP_1NNN_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('1FFF', opcodes[0])
    ...
    def test_convert_JMP_BNNN_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('BFFF', opcodes[0])
    ...
    def test_convert_CALL_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('2FFF', opcodes[0])
    ...
    def test_convert_SE_3XNN_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('30FF', opcodes[0])
    ...
    def test_convert_SE_5XY0_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('5010', opcodes[0])
    ...
    def test_convert_SNE_4XNN_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('40AE', opcodes[0])
    ...
    def test_convert_SNE_9XY0_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('9150', opcodes[0])
    ...
    def test_convert_ADD_7XNN_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('72FF', opcodes[0])
    ...
    def test_convert_ADD_8XY4_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('8264', opcodes[0])
    ...
    def test_convert_OR_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('8261', opcodes[0])
    ...
    def test_convert_AND_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('8262', opcodes[0])
    ...
    def test_convert_XOR_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('8263', opcodes[0])
    ...
    def test_convert_SUB_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('8345', opcodes[0])
    ...
    def test_convert_SHR_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('8346', opcodes[0])

    def test_convert_SUBC_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('8347', opcodes[0])
    ...
    def test_convert_SHL_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('834E', opcodes[0])
    ...
    def test_convert_LDI_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('AFFE', opcodes[0])
    ...
    def test_convert_RND_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('C1FF', opcodes[0])
    ...
    def test_convert_DRW_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('D19F', opcodes[0])
    ...
    def test_convert_SKP_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('E09E', opcodes[0])
    ...
    def test_convert_SKNP_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('E0A1', opcodes[0])

    def test_convert_STR_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('F155', opcodes[0])
    ...
    def test_convert_FILL_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('F165', opcodes[0])
    ...
    def test_convert_LD_6XNN_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('60FF', opcodes[0])
    ...
    def test_convert_LD_8XY0_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('8020', opcodes[0])
    ...
    def test_convert_LD_FX07_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('F107', opcodes[0])
    ...
    def test_convert_LD_FX0A_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('F20A', opcodes[0])
    ...
    def test_convert_LD_FX15_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('F015', opcodes[0])
    ...
    def test_convert_LD_FX18_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('F318', opcodes[0])
    ...
    def test_convert_LD_FX1E_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('F41E', opcodes[0])
    ...
    def test_convert_LD_FX29_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('F529', opcodes[0])
    ...
    def test_convert_LD_FX33_node_to_opcode(self):
        ...
        # Arrange:
        self.assertEqual('F633', opcodes[0])
